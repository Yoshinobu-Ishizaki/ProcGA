...
# function isgroupable(x,gp::Array{JobGroup,1})
...
# function groupcapacity(x, gp::Array{JobGroup,1})
#     for i in 1:length(gp)
#         if x in gp[i].ids
#             return gp[i].lmt
#         end
...
# should be replaced with listbadgroup function
...
# function listduplicate(jtbl::Array{Array{Int,1},1}, glst::Array{Array{Int,1},1}, lmt::Array{Int,1})
# end
